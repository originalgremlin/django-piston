...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Consumer', fields ['key', 'secret']
        db.create_unique('piston_consumer', ['key', 'secret'])
        ...
        db.create_table('piston_token', (
            ...
            ('timestamp', self.gf('django.db.models.fields.IntegerField')(default=1321764149L)),
    ...
    def backwards(self, orm):
        ...
        # Removing unique constraint on 'Consumer', fields ['key', 'secret']
        db.delete_unique('piston_consumer', ['key', 'secret'])
    ...
    models = {
        ...
        'piston.consumer': {
            'Meta': {'unique_together': "(('key', 'secret'),)", 'object_name': 'Consumer'},
        ...
        'piston.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1321764149L'}),
